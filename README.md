...
| `design-sketch-review` | [`design-sketch-review/SKILL.md`](design-sketch-review/SKILL.md) | 设计文档"草图先行"评审闭环：先产出交互式 HTML 评审草图（大白话、可视化）供用户点选确认，按反馈就地迭代留痕，评审通过后再输出正式 markdown 设计文档。 |
